            ...
            <div className="w-full max-w-5xl bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                    ...
                    <div className="hidden md:flex flex-col justify-between bg-gradient-to-br from-blue-600 via-teal-500 to-blue-800 p-12 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg text-blue-100 font-semibold mb-2">
                                Smart Transport for Badulla District
                            </p>
                            <p className="text-blue-50 text-sm leading-relaxed">
                                Plan and manage your journeys with real-time schedules, fare estimates, and reliable routing
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-center p-8 md:p-12">
                        ...
                        {/* Heading */}
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Create Your GoBus Account</h1>
                        <p className="text-gray-600 text-sm mb-8">
                            Join GoBus to plan and manage your journeys
                        </p>
